...
if isempty(portfolio)
    ...
    %Fill portfolio with any layers, including those that aren't currently
    %selectable (will be flagged as aspirations)
    tempSelectable = ones(1,portfolioLayers);

    portfolio = fillPortfolio(portfolio,constraints,tempSelectable,portfolioPrereqs);
    ...
    if modelParameters.aspirationsFlag == 0
        ...
        if any(aspirations)
            ...
            samplePortfolio = fillPortfolio(samplePortfolio,constraints,selectable,portfolioPrereqs);
            ...
            if medTermFlag == true
                ...
                tempPortfolio = fillPortfolio(tempPortfolio,constraints,selectableLayers,portfolioPrereqs);
    ...
    %If portfolio layers are already specified   
        ...
        portfolio = fillPortfolio(portfolio,constraints,selectable,portfolioPrereqs);
